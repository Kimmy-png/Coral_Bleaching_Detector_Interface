...
with st.sidebar:
    ...
    page = st.radio(
        "Navigasi",
        ["Peta & Ringkasan", "Rekomendasi Zona Tangkap", "Early Warning System", "Detail Zona"],
    ...
    st.markdown("---")
    st.caption("Catatan: seluruh data pada dashboard ini adalah data dummy untuk keperluan demo antarmuka.")
...
# --------------------------------------------------------------------------------------
    ...
    for _, row in alerts.iterrows():
        ...
        st.markdown(f"""
        <div class="zone-card {cls}">
            <b>{row.zone_name}</b>, {row.province}
